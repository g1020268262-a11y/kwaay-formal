...
We consider a symbolic network adversary whose relevant capability in this
analysis is control over batch composition. It acts at the interface between
...
tuples may differ in occurrence, message, or both. The capability is therefore

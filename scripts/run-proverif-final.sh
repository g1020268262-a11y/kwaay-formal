...

{
  ...
  echo "CLASSIFICATION / EXPERIMENT TARGETS: RECEIVER_EXCEPTION_CLASSIFICATION LEAK_SIGSK LEAK_KEMSK LEAK_EKEMSK LEAK_RSKEMSK LEAK_SSKEMSK LEAK_KEMSK_EKEMSK LEAK_ALL_RECEIVER_SECRETS"
  echo
} > "$SUMMARY"
